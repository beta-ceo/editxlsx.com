...
export const en: I18nMessages = {
  ...
  cloudSearchResults: 'Search results',
  cloudOpen: 'Open',
  cloudDelete: 'Delete',
  cloudDeleteTitle: 'Delete "{title}"',
  cloudDeleteConfirm: 'Delete "{title}" from your account? This cannot be undone.',
  cloudBatchSelected: '{count} selected',
  cloudBatchSelectAll: 'Select all',
  cloudBatchClear: 'Clear',
  cloudBatchMove: 'Move',
  cloudBatchDelete: 'Delete',
  cloudBatchDeleteTitle: 'Delete {count} items',
  cloudBatchDeleteConfirm: 'Delete {count} selected items from your account? This cannot be undone.',
  cloudBatchMoveTitle: 'Move {count} items',
  cloudBatchMoveBody: 'Choose a destination folder.',
  cloudBatchMoveHere: 'Move here',
  cloudBatchRoot: 'My workbooks',
  cloudBatchMoveFailed: 'Could not move some items.',
  cloudBatchDeletePartial: 'Deleted {done} of {total}. Some items could not be deleted.',
  cloudSort: 'Sort',
  cloudSortCreated: 'Date created',
  cloudSortSize: 'File size',
  cloudSortName: 'Name',
  cloudSortType: 'Type',
  cloudSortAsc: 'Ascending',
  cloudSortDesc: 'Descending',
  cloudCancel: 'Cancel',
  cloudSearchPlaceholder: 'Search workbooks',
  ...
  cloudExport: 'Export',
  cloudExportPdf: 'Export PDF',
  cloudExportPdfFailed: 'Could not export PDF: ',
