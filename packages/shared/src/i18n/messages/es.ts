...
export const es: Partial<I18nMessages> = {
  ...
  cloudUploadQueue: 'Cola de subida',
  cloudUploadQueueItems: '{count} elementos',
  cloudUploadQueued: 'En cola · Esperando turno',
  cloudUploadProgressDetail: '{percent}% · {loaded} de {total}',
  cloudUploadReady: 'Listo para abrir',
  cloudUploadClearCompleted: 'Borrar completados ({count})',
  cloudUploadFailed: 'Error al subir',
  ...
  cloudBatchSelected: '{count} seleccionados',
  cloudBatchSelectAll: 'Seleccionar todo',
  cloudBatchClear: 'Quitar selección',
  cloudBatchMove: 'Mover',
  cloudBatchDelete: 'Eliminar',
  cloudBatchDeleteTitle: 'Eliminar {count} elementos',
  cloudBatchDeleteConfirm: '¿Eliminar {count} elementos seleccionados de tu cuenta? No se puede deshacer.',
  cloudBatchMoveTitle: 'Mover {count} elementos',
  cloudBatchMoveBody: 'Elige una carpeta de destino.',
  cloudBatchMoveHere: 'Mover aquí',
  cloudBatchRoot: 'Mis libros',
  cloudBatchMoveFailed: 'No se pudieron mover algunos elementos.',
  cloudBatchDeletePartial: 'Se eliminaron {done} de {total}. Algunos elementos no se pudieron eliminar.',
  cloudSort: 'Ordenar',
  cloudSortCreated: 'Fecha de creación',
  cloudSortSize: 'Tamaño',
  cloudSortName: 'Nombre',
  cloudSortType: 'Tipo',
  cloudSortAsc: 'Ascendente',
  cloudSortDesc: 'Descendente',
