...
export const de: Partial<I18nMessages> = {
  ...
  cloudOpeningDownload: 'Wird aus dem Konto heruntergeladen…',
  cloudOpeningEditor: 'Wird im Editor geöffnet…',
  cloudOpeningStepDownload: 'Laden',
  cloudOpeningStepEditor: 'Öffnen',
