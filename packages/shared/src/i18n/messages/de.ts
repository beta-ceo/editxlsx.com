...
export const de: Partial<I18nMessages> = {
  ...
  cloudSignIn: 'Anmelden',
  cloudSignUp: 'Konto erstellen',
  cloudSignOut: 'Abmelden',
  cloudEmail: 'E-Mail',
  cloudPassword: 'Passwort',
  cloudNameOptional: 'Anzeigename (optional)',
  cloudPasswordHint: 'Mindestens 8 Zeichen',
  cloudHaveAccount: 'Bereits ein Konto? Anmelden',
  cloudNeedAccount: 'Neu hier? Konto erstellen',
  cloudAuthFailed: 'Anmeldung fehlgeschlagen: ',
  cloudFilesTitle: 'Meine Arbeitsmappen',
  cloudFilesIntro:
  ...
  cloudNewPresentation: 'Neue Präsentation',
  cloudNewFolder: 'Neuer Ordner',
  cloudComingSoon: 'Demnächst verfügbar',
  cloudFolderNotEmpty: 'Dieser Ordner ist nicht leer.',
  cloudFolderUntitled: 'Unbenannter Ordner',
  cloudNavUp: 'Nach oben',
  cloudUploadWorkbook: '.xlsx hochladen',
  cloudUpload: 'Hochladen',
  cloudUploadTypeError: 'Nur .xlsx-, .docx- und .pptx-Dateien können hochgeladen werden.',
  cloudUploadProgress: 'Hochladen {current} von {total} · {name}',
  cloudUploadDone: '{count} Datei(en) hochgeladen',
  cloudUploadQueue: 'Upload-Warteschlange',
  cloudUploadQueueItems: '{count} Einträge',
  cloudUploadQueued: 'Wartend · Slot frei machen',
  cloudUploadProgressDetail: '{percent}% · {loaded} von {total}',
  cloudUploadReady: 'Bereit zum Öffnen',
  cloudUploadClearCompleted: 'Abgeschlossene löschen ({count})',
  cloudUploadFailed: 'Upload fehlgeschlagen',
  cloudFolderEmptyHint: 'Erstellen Sie eine neue Datei oder laden Sie eine in diesen Ordner hoch.',
  cloudDropOffice: 'Oder .xlsx-, .docx- oder .pptx-Dateien/Ordner hier ablegen',
  cloudDropHeadline: 'Dokumente oder Tabellen hierher ziehen',
  cloudDropFormats: 'Unterstützt .xlsx, .docx und .pptx bis {size} pro Datei',
  cloudBrowseLocal: 'Lokale Dateien durchsuchen',
  cloudEmptyTitle: 'Noch keine Arbeitsmappen',
  cloudEmpty: 'Erstellen Sie eine leere Arbeitsmappe oder laden Sie eine .xlsx hoch.',
  cloudEmptySearchTitle: 'Keine Treffer',
  cloudEmptySearch: 'Kein Dateiname enthält diesen Text.',
  cloudOpen: 'Öffnen',
  cloudDelete: 'Löschen',
  cloudDeleteTitle: 'Diese Arbeitsmappe löschen',
  cloudDeleteConfirm: '„{title}“ aus Ihrem Konto löschen? Das kann nicht rückgängig gemacht werden.',
  cloudBatchSelected: '{count} ausgewählt',
  cloudBatchSelectAll: 'Alle auswählen',
  cloudBatchClear: 'Auswahl aufheben',
  cloudBatchMove: 'Verschieben',
  cloudBatchDelete: 'Löschen',
  cloudBatchDeleteTitle: '{count} Elemente löschen',
  cloudBatchDeleteConfirm: '{count} ausgewählte Elemente aus Ihrem Konto löschen? Das kann nicht rückgängig gemacht werden.',
  cloudBatchMoveTitle: '{count} Elemente verschieben',
  cloudBatchMoveBody: 'Zielordner wählen.',
  cloudBatchMoveHere: 'Hierher verschieben',
  cloudBatchRoot: 'Meine Arbeitsmappen',
  cloudBatchMoveFailed: 'Einige Elemente konnten nicht verschoben werden.',
  cloudBatchDeletePartial: '{done} von {total} gelöscht. Einige Elemente konnten nicht gelöscht werden.',
  cloudSort: 'Sortieren',
  cloudSortCreated: 'Erstellt am',
  cloudSortSize: 'Dateigröße',
  cloudSortName: 'Name',
  cloudSortType: 'Typ',
  cloudSortAsc: 'Aufsteigend',
  cloudSortDesc: 'Absteigend',
  cloudCancel: 'Abbrechen',
  cloudSearchPlaceholder: 'Nach Dateiname suchen',
  cloudColDocument: 'Arbeitsmappe',
  cloudColEdited: 'Zuletzt bearbeitet',
  cloudColSize: 'Größe',
  cloudBack: 'Zurück zu den Arbeitsmappen',
  cloudSaved: 'In Ihrem Konto gespeichert',
  cloudSaveFailed: 'Speichern im Konto fehlgeschlagen: ',
  cloudAutosaveStopped: 'Cloud-Autosave nach wiederholten Fehlern gestoppt. Speichern Sie manuell erneut.',
  cloudOpenFailed: 'Arbeitsmappe konnte nicht geöffnet werden: ',
  cloudNotConfigured: 'Cloud-Speicher ist in diesem Build nicht verfügbar.',
  cloudSignedInAs: 'Angemeldet als {email}',
  cloudOpenEditor: 'Dokumenteditor öffnen',
  cloudNavHome: 'Startseite',
  cloudNavDirectory: 'Verzeichnis',
  cloudNavWorkspace: 'Arbeitsbereich',
  cloudAllDocuments: 'Alle Dokumente',
  cloudNavDocuments: 'Dokumente',
  cloudStorage: 'Speicher',
  cloudStorageUsed: '{size} belegt',
  cloudExport: 'Exportieren',
  cloudSavedWhen: '{when} gespeichert',
  cloudSelectWorkbook: 'Wählen Sie links eine Arbeitsmappe, um sie hier zu bearbeiten.',
  cloudWorkspaceMine: 'Mein Arbeitsbereich',
  cloudNew: 'Neu',
  cloudHelp: 'Hilfe',
