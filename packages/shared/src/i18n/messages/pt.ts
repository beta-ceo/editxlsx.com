...
export const pt: Partial<I18nMessages> = {
  ...
  cloudNewDocument: 'Novo documento',
  cloudNewPresentation: 'Nova apresentação',
  cloudNewFolder: 'Nova pasta',
  cloudComingSoon: 'Em breve',
  cloudFolderNotEmpty: 'A pasta ainda tem conteúdo.',
  cloudFolderUntitled: 'Pasta sem título',
  cloudNavUp: 'Acima',
  cloudUploadWorkbook: 'Carregar .xlsx',
  cloudUpload: 'Carregar',
  cloudUploadTypeError: 'Só é possível carregar ficheiros .xlsx, .docx e .pptx.',
  cloudUploadProgress: 'A carregar {current} de {total} · {name}',
  cloudUploadDone: '{count} ficheiro(s) carregado(s)',
  cloudUploadQueue: 'Fila de carregamento',
  cloudUploadQueueItems: '{count} itens',
  cloudUploadQueued: 'Na fila · À espera de vez',
  cloudUploadProgressDetail: '{percent}% · {loaded} de {total}',
  cloudUploadReady: 'Pronto para abrir',
  cloudUploadClearCompleted: 'Limpar concluídos ({count})',
  cloudUploadFailed: 'Falha no carregamento',
  cloudFolderEmptyHint: 'Crie um ficheiro novo ou carregue um para esta pasta.',
  cloudDropOffice: 'Ou largue ficheiros ou pastas .xlsx, .docx ou .pptx aqui',
  cloudDropHeadline: 'Arraste e largue documentos ou folhas aqui',
  cloudDropFormats: 'Suporta .xlsx, .docx e .pptx até {size} cada',
  cloudBrowseLocal: 'Procurar ficheiros locais',
  ...
  cloudBatchSelected: '{count} selecionados',
  cloudBatchSelectAll: 'Selecionar tudo',
  cloudBatchClear: 'Limpar seleção',
  cloudBatchMove: 'Mover',
  cloudBatchDelete: 'Eliminar',
  cloudBatchDeleteTitle: 'Eliminar {count} itens',
  cloudBatchDeleteConfirm: 'Eliminar {count} itens selecionados da sua conta? Isto não pode ser anulado.',
  cloudBatchMoveTitle: 'Mover {count} itens',
  cloudBatchMoveBody: 'Escolha a pasta de destino.',
  cloudBatchMoveHere: 'Mover para aqui',
  cloudBatchRoot: 'As minhas folhas',
  cloudBatchMoveFailed: 'Não foi possível mover alguns itens.',
  cloudBatchDeletePartial: 'Eliminados {done} de {total}. Alguns itens não puderam ser eliminados.',
  cloudSort: 'Ordenar',
  cloudSortCreated: 'Data de criação',
  cloudSortSize: 'Tamanho',
  cloudSortName: 'Nome',
  cloudSortType: 'Tipo',
