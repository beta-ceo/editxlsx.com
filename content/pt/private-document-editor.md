...
1. Abra o editor — nenhuma tela de cadastro no caminho.
2. Escolha um arquivo DOCX, XLSX, PPTX ou CSV do seu dispositivo.
3. Leia e edite localmente; o arquivo é processado no seu navegador, não num servidor.
4. Baixe suas alterações de volta para o dispositivo quando terminar.
...
Sem conta, sem cadastro e sem login. Você abre o editor e trabalha na hora, e não há cópia na nuvem do seu documento para gerenciar.
