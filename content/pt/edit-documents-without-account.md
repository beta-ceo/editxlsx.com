...
1. Abra o editor — nenhuma tela de cadastro aparece.
2. Escolha um arquivo DOCX, XLSX, PPTX ou CSV do seu dispositivo.
3. Edite direto no navegador; o arquivo é processado localmente, não num servidor.
4. Baixe o arquivo pronto de volta para o seu dispositivo.

## Perguntas frequentes

### Dá para editar documentos sem criar conta?

Sim. Não há conta, cadastro nem login. Você abre o editor e já pode editar seu DOCX, XLSX, PPTX ou CSV.

### Preciso informar um e-mail?

Não. Como não existe etapa de cadastro, nunca pedimos e-mail, telefone ou dados pessoais.
