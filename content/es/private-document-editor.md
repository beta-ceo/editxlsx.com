...
description: Un editor de documentos privado que mantiene tus archivos en tu dispositivo. Edita Word (DOCX), Excel (XLSX), PowerPoint (PPTX) y CSV 100% en local, en tu navegador: no se sube nada. Gratis, de código abierto (MIT), funciona sin conexión.
...
1. Abre el editor: no hay pantalla de registro en medio.
2. Elige un archivo DOCX, XLSX, PPTX o CSV de tu dispositivo.
3. Léelo y edítalo en local; el archivo se procesa en tu navegador, no en un servidor.
4. Descarga tus cambios de vuelta a tu dispositivo cuando termines.

## Preguntas frecuentes

### ¿Qué hace que este sea un editor de documentos privado?

Tus archivos se abren y se editan por completo dentro de tu propio navegador con WebAssembly. El documento nunca se sube a un servidor, así que permanece en tu dispositivo todo el tiempo.

### ¿Se llegan a subir mis archivos?

No. Todo el procesamiento es 100% en el cliente. Tu archivo DOCX, XLSX, PPTX o CSV se lee y se escribe en local y nunca sale de tu dispositivo.

### ¿Necesito una cuenta para que mis archivos sean privados?

Sin cuenta, sin registro y sin inicio de sesión. Abres el editor y trabajas de inmediato, y no hay ninguna copia en la nube de tu documento que gestionar.

### ¿Puedo verificar que no se sube nada?

Sí. El editor entero es de código abierto bajo la licencia MIT: puedes leer el código, mirar la pestaña de red o alojar tu propia copia.
