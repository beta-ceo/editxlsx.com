...
いいえ。ドキュメントはディスクからブラウザのタブへ読み込まれ、そこで WebAssembly によって処理されます。このサイトにアップロード用のエンドポイントは存在しません。ドキュメントを開いて保存する際にブラウザのネットワークパネルで確認できますし、アプリケーションのソースは MIT で公開されています。
